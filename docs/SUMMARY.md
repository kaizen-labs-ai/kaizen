...
* [Brave Search](integrations/brave-search.md)
* [Browser Automation](integrations/browser.md)
* [MCP Servers](integrations/mcp.md)

## Configuration

* [Settings](settings/overview.md)
* [Agents](settings/agents.md)
* [Soul & Personality](settings/soul.md)
* [Memory](settings/memory.md)
* [Vault & Secrets](settings/vault.md)
* [Voice Input](settings/voice.md)
* [Backup & Recovery](settings/backup.md)
